...
abstract class FlutterFlowTheme {
  ...
  late Color white;
  late Color polenta;
  late Color blankCanvas;
  late Color waxFlower;
  late Color underground;
  late Color northAtlantic;
  late Color tastyCrust;
  late Color latte;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color polenta = const Color(0xFFF0C47C);
  late Color blankCanvas = const Color(0xFFFDEED6);
  late Color waxFlower = const Color(0xFFF3B295);
  late Color underground = const Color(0xFF685B50);
  late Color northAtlantic = const Color(0xFF9E5696);
  late Color tastyCrust = const Color(0xFFA57D4A);
  late Color latte = const Color(0xFFD1A07F);
}
